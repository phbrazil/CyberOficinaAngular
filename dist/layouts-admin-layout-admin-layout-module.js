...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(formBuilder, route, router, accountService, alertService) {
    ...
    UserProfileComponent.prototype.ngOnInit = function () {
        ...
        this.profile = this.formBuilder.group({
            ...
            pais: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
        });
        this.isLoading = true;
        this.accountService.getById(this.user.id)
            ...
            _this.pais = 'Brasil';
            _this.cep = data.cep;
            _this.logradouro = data.rua;
            _this.numero = data.numero;
            _this.complemento = data.complemento;
            _this.bairro = data.bairro;
            _this.cidade = data.cidade;
            _this.uf = data.uf;
            _this.empresa = '9ember';
            _this.celular = data.celular;
            _this.telefone = data.telefone;
            _this.isLoading = false;
            _this.loadCurrentAddress();
        }, function (error) {
            _this.isLoading = false;
            _this.alertService.error("Erro " + error.status + ", favor tentar novamente mais tarde");
        });
    };
    Object.defineProperty(UserProfileComponent.prototype, "a", {
        get: function () { return this.profile.controls; },
        enumerable: false,
        configurable: true
    });
    UserProfileComponent.prototype.getCep = function (cep) {
        var _this = this;
        cep = cep.replace(/\D/g, '');
        if (cep !== '') {
            var validaCep = /^[0-9]{8}$/;
            if (validaCep.test(cep)) {
                this.accountService.cep(cep)
                    ...
                    _this.patchNewAddress(dados);
                }, function (error) {
                    //this.alertService.error(error);
                    _this.isLoadingCEP = false;
                });
            }
            else {
    ...
    UserProfileComponent.prototype.patchNewAddress = function (dados) {
        var address = {
    ...
    UserProfileComponent.prototype.loadCurrentAddress = function () {
        var currentAddress = {
            cep: this.cep,
    ...
    UserProfileComponent.prototype.onSubmit = function () {
        ...
        this.accountService.update(this.user.id, this.profile.value)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])())
            .subscribe(function (data) {
            _this.alertService.success('Dados atualizados com sucesso', { keepAfterRouteChange: true });
            _this.ngOnInit();
            //this.router.navigate(['../login'], { relativeTo: this.route });
        }, function (error) {
            _this.alertService.error("Occorreu um erro, tente novamente mais tarde: Status ", error.status);
            _this.isLoading = false;
        });
    };
...
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
var LayoutModule = function LayoutModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, LayoutModule);
};
...
var MediaMatcher = /*#__PURE__*/function () {
  function MediaMatcher(_platform) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, MediaMatcher);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(MediaMatcher, [{
    key: "matchMedia",
...
var BreakpointObserver = /*#__PURE__*/function () {
  function BreakpointObserver(_mediaMatcher, _zone) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, BreakpointObserver);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_0__["default"])(BreakpointObserver, [{
    key: "ngOnDestroy",
...
/***/ "AJKm":
/*!***************************************************!*\
  !*** ./src/app/orcamento/orcamento.component.css ***!
  \***************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL29yY2FtZW50by9vcmNhbWVudG8uY29tcG9uZW50LmNzcyJ9 */");
...
/* harmony import */ var app_orcamento_orcamento_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! app/orcamento/orcamento.component */ "TXLl");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AdminLayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                app_orcamento_orcamento_component__WEBPACK_IMPORTED_MODULE_19__["OrcamentoComponent"],
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(accountService) {
        this.accountService = accountService;
        this.isLogged = false;
        this.user = JSON.parse(localStorage.getItem('user'));
    }
    ...
    //LIST PENDING ORCS
    DashboardComponent.prototype.listOrcs = function (idUser) {
        var _this = this;
        this.accountService.listOrcs(idUser)
            ...
            _this.pendingOrcs = x['totalElements'];
        });
    };
...
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "ODXe");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
...
var MatTooltip = /*#__PURE__*/function () {
  function MatTooltip(_overlay, _elementRef, _scrollDispatcher, _viewContainerRef, _ngZone, _platform, _ariaDescriber, _focusMonitor, scrollStrategy, _dir, _defaultOptions) {
    ...
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, MatTooltip);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(MatTooltip, [{
    key: "position",
    get: function get() {
    ...
    value: function ngOnDestroy() {
      ...
      this._passiveListeners.forEach(function (_ref) {
        var _ref2 = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref, 2),
            event = _ref2[0],
            listener = _ref2[1];
    ...
    value: function _addListeners(listeners) {
      ...
      listeners.forEach(function (_ref3) {
        var _ref4 = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref3, 2),
            event = _ref4[0],
            listener = _ref4[1];
...
var TooltipComponent = /*#__PURE__*/function () {
  function TooltipComponent(_changeDetectorRef, _breakpointObserver) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, TooltipComponent);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(TooltipComponent, [{
    key: "show",
...
var MatTooltipModule = function MatTooltipModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_1__["default"])(this, MatTooltipModule);
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n  <div class=\"container-fluid\">\n    <div *ngIf=\"isLoading\" class=\"spinner-border text-success\" role=\"status\">\n      <span class=\"sr-only\">Carregando...</span>\n    </div>\n    <div *ngIf=\"!isLoading\" class=\"row\">\n      <div class=\"col-md-8\">\n        <div class=\"card\">\n          <div class=\"card-header card-header-info\">\n            <h4 class=\"card-title\">Editar Perfil</h4>\n            <p class=\"card-category\">Complete seu perfil</p>\n          </div>\n          <div class=\"card-body\">\n            <form [formGroup]=\"profile\" (ngSubmit)=\"onSubmit()\">\n              <div class=\"row\">\n                <div class=\"col-md-3\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput placeholder=\"{{empresa}}\" disabled>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput placeholder=\"{{nome}}\" disabled>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-5\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput placeholder=\"{{email}}\" disabled>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-3\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput placeholder=\"{{cpf}}\" disabled>\n                  </mat-form-field>\n                </div>\n              </div>\n              <div class=\"row\">\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input (change)=\"getCep($event.target.value)\" formControlName=\"cep\" matInput \n                      placeholder=\"CEP\" type=\"text\" [ngClass]=\"{ 'is-invalid': submitted && a.cep.errors }\" />\n                    <div *ngIf=\"submitted && a.cep.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.cep.errors.required\">CEP necessário</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-6\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput formControlName=\"logradouro\" placeholder=\"Rua\" type=\"text\"\n                      [ngClass]=\"{ 'is-invalid': submitted && a.logradouro.errors }\" />\n                    <div *ngIf=\"submitted && a.logradouro.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.logradouro.errors.required\">Logradouro necessário</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-2\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput formControlName=\"numero\" placeholder=\"Número\" type=\"text\"\n                      [ngClass]=\"{ 'is-invalid': submitted && a.numero.errors }\" />\n                    <div *ngIf=\"submitted && a.numero.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.numero.errors.required\">Número necessário</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput value=\"{{complemento}}\" placeholder=\"Complemento\" type=\"text\">\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput value=\"{{bairro}}\" formControlName=\"bairro\" placeholder=\"Bairro\" type=\"text\"\n                      [ngClass]=\"{ 'is-invalid': submitted && a.bairro.errors }\" />\n                    <div *ngIf=\"submitted && a.bairro.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.bairro.errors.required\">Bairro necessário</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput formControlName=\"cidade\" placeholder=\"Cidade\" type=\"text\"\n                      [ngClass]=\"{ 'is-invalid': submitted && a.cidade.errors }\" />\n                    <div *ngIf=\"submitted && a.cidade.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.cidade.errors.required\">Cidade necessária</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput formControlName=\"uf\" placeholder=\"Estado\" type=\"text\"\n                      [ngClass]=\"{ 'is-invalid': submitted && a.uf.errors }\" />\n                    <div *ngIf=\"submitted && a.uf.errors\" class=\"invalid-feedback\">\n                      <div *ngIf=\"a.uf.errors.required\">UF necessária</div>\n                    </div>\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput formControlName=\"pais\" placeholder=\"País\" type=\"text\">\n                  </mat-form-field>\n                </div>\n              </div>\n              <div class=\"row\">\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput value=\"{{celular}}\" placeholder=\"Celular\" type=\"text\">\n                  </mat-form-field>\n                </div>\n                <div class=\"col-md-4\">\n                  <mat-form-field class=\"example-full-width\">\n                    <input matInput value=\"{{telefone}}\" placeholder=\"Telefone\" type=\"text\">\n                  </mat-form-field>\n                </div>\n              </div>\n              <div *ngIf=\"spec\" class=\"row\">\n                <div class=\"col-md-12\">\n                  <label>Sobre</label>\n                  <mat-form-field class=\"example-full-width\">\n                    <textarea matInput placeholder=\"Co-Fundador e CEO da Cyber Oficina\"></textarea>\n                  </mat-form-field>\n                </div>\n              </div>\n              <button [disabled]=\"loading\" class=\"btn btn-info\">\n                <span *ngIf=\"loading\" class=\"spinner-border spinner-border-sm mr-1\"></span>\n                Atualizar\n              </button>\n              <div class=\"clearfix\"></div>\n            </form>\n          </div>\n        </div>\n      </div>\n      <div class=\"col-md-4\">\n        <div class=\"card card-profile\">\n          <div class=\"card-avatar\">\n            <a href=\"javascript:void(0)\">\n              <img class=\"img\" src=\"./assets/img/faces/marc.jpeg\" />\n            </a>\n          </div>\n          <div class=\"card-body\">\n            <h6 class=\"card-category text-gray\">CEO / Co-Fundador</h6>\n            <h4 class=\"card-title\">{{nome}}</h4>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>");

/***/ }),

/***/ "TXLl":
/*!**************************************************!*\
  !*** ./src/app/orcamento/orcamento.component.ts ***!
  \**************************************************/
/*! exports provided: OrcamentoComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OrcamentoComponent", function() { return OrcamentoComponent; });
/* harmony import */ var _raw_loader_orcamento_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./orcamento.component.html */ "l0NU");
/* harmony import */ var _orcamento_component_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./orcamento.component.css */ "AJKm");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var app_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/_services */ "J9tS");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrcamentoComponent = /** @class */ (function () {
    function OrcamentoComponent(formBuilder, alertService) {
        this.formBuilder = formBuilder;
        this.alertService = alertService;
        this.loading = false;
        this.submitted = false;
    ...
    OrcamentoComponent.prototype.ngOnInit = function () {
        this.orcamento = this.formBuilder.group({
            ...
            veiculo: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required],
        });
    };
    OrcamentoComponent.prototype.checkVeiculo = function (veiculo) {
        var _this = this;
        this.veiculo = false;
        this.marcas.forEach(function (element) {
    ...
    OrcamentoComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
        { type: app_services__WEBPACK_IMPORTED_MODULE_4__["AlertService"] }
    ]; };
    OrcamentoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            selector: 'app-orcamento',
            template: _raw_loader_orcamento_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
            styles: [_orcamento_component_css__WEBPACK_IMPORTED_MODULE_1__["default"]]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], app_services__WEBPACK_IMPORTED_MODULE_4__["AlertService"]])
    ], OrcamentoComponent);
...
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray */ "KQm4");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/assertThisInitialized */ "JX7q");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/inherits */ "Ji7U");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createSuper */ "LK+K");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
...
value) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__["default"])(this, MatSelectChange);
...
var MatSelectBase = function MatSelectBase(_elementRef, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__["default"])(this, MatSelectBase);
...
var MatSelectTrigger = function MatSelectTrigger() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__["default"])(this, MatSelectTrigger);
};
...
var MatSelect = /*#__PURE__*/function (_MatSelectMixinBase2) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_3__["default"])(MatSelect, _MatSelectMixinBase2);

  var _super = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_4__["default"])(MatSelect);
  ...
  function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, defaults) {
    ...
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__["default"])(this, MatSelect);
    ...
    _this.optionSelectionChanges = Object(rxjs__WEBPACK_IMPORTED_MODULE_18__["defer"])(function () {
      ...
      if (options) {
        return options.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["startWith"])(options), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_19__["switchMap"])(function () {
          return rxjs__WEBPACK_IMPORTED_MODULE_18__["merge"].apply(void 0, Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(options.map(function (option) {
    ...
    if (_this.ngControl) {
      ...
      _this.ngControl.valueAccessor = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this);
    }
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MatSelect, [{
    key: "focused",
    get: function get() {
    ...
    value: function _resetOptions() {
      ...
      rxjs__WEBPACK_IMPORTED_MODULE_18__["merge"].apply(void 0, Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this.options.map(function (option) {
...
var MatSelectModule = function MatSelectModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_5__["default"])(this, MatSelectModule);
};
...
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
...
var AutofillMonitor = /*#__PURE__*/function () {
  function AutofillMonitor(_platform, _ngZone) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, AutofillMonitor);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AutofillMonitor, [{
    key: "monitor",
...
var CdkAutofill = /*#__PURE__*/function () {
  function CdkAutofill(_elementRef, _autofillMonitor) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, CdkAutofill);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CdkAutofill, [{
    key: "ngOnInit",
    value: function ngOnInit() {
      var _this3 = this;
...
var CdkTextareaAutosize = /*#__PURE__*/function () {
  ...
  document) {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, CdkTextareaAutosize);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CdkTextareaAutosize, [{
    key: "minRows",
    get: function get() {
...
var TextFieldModule = function TextFieldModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, TextFieldModule);
};
...
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray */ "KQm4");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "vuIU");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/inherits */ "Ji7U");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createSuper */ "LK+K");
/* harmony import */ var _Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "1OyB");
...
var MatError = function MatError() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatError);
...
var MatFormFieldControl = function MatFormFieldControl() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatFormFieldControl);
};
...
var MatHint = function MatHint() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatHint);
...
var MatLabel = function MatLabel() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatLabel);
};
...
var MatPlaceholder = function MatPlaceholder() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatPlaceholder);
};
...
var MatPrefix = function MatPrefix() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatPrefix);
};
...
var MatSuffix = function MatSuffix() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatSuffix);
};
...
var MatFormFieldBase = function MatFormFieldBase(_elementRef) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatFormFieldBase);
...
var MatFormField = /*#__PURE__*/function (_MatFormFieldMixinBas) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MatFormField, _MatFormFieldMixinBas);

  var _super = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_3__["default"])(MatFormField);

  function MatFormField(_elementRef, _changeDetectorRef, labelOptions, _dir, _defaults, _platform, _ngZone, _animationMode) {
    var _this;

    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatFormField);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MatFormField, [{
    key: "appearance",
    get: function get() {
    ...
    value: function _syncDescribedByIds() {
      if (this._control) {
        ...
        if (this._control.userAriaDescribedBy && typeof this._control.userAriaDescribedBy === 'string') {
          ids.push.apply(ids, Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this._control.userAriaDescribedBy.split(' ')));
        }
        ...
        if (this._getDisplayedMessages() === 'hint') {
          ...
          ids.push.apply(ids, Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(this._errorChildren.map(function (error) {
            return error.id;
          })));
        }
...
var MatFormFieldModule = function MatFormFieldModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, MatFormFieldModule);
};
...
/***/ "l0NU":
/*!******************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/orcamento/orcamento.component.html ***!
  \******************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n    <div class=\"container-fluid\">\n\n        <div>\n            <form (ngSubmit)=\"onSubmit()\" [formGroup]=\"orcamento\">\n\n                <div class=\"form-group\">\n                    <div class=\"row\">\n                        <div class=\"col-md-4\">\n                            <label for=\"marca\">Fabricante (Ex.: Nissan)</label>\n                            <input (change)=\"checkVeiculo($event.target.value)\" formControlName=\"marca\" placeholder=\"Digite\" class=\"form-control\" list=\"marcas\">\n                            <datalist id=\"marcas\">\n                                <option *ngFor=\"let marca of marcas\">{{marca.nome}} </option>\n                            </datalist>\n                        </div>\n                        <div *ngIf=\"veiculo\" class=\"col-md-4\">\n                            <label for=\"veiculo\">Veículo</label>\n                            <input class=\"form-control\" list=\"veiculos\" name=\"veiculos\">\n                            <datalist id=\"veiculos\">\n                                <option *ngFor=\"let veiculo of veiculos\">{{veiculo.nome}} </option>\n                            </datalist>\n                        </div>\n                    </div>\n                </div>\n\n                <div class=\"form-group\">\n                    <button [disabled]=\"loading\" class=\"btn btn-primary\">\n                        <span *ngIf=\"loading\" class=\"spinner-border spinner-border-sm mr-1\"></span>\n                        Criar Orçamento\n                    </button>\n                    <a routerLink=\"../dashboard\" class=\"btn btn-link\">Cancelar</a>\n                </div>\n            </form>\n        </div>\n\n    </div>\n</div>");
...
var MatTextareaAutosize = /*#__PURE__*/function (_CdkTextareaAutosize) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MatTextareaAutosize, _CdkTextareaAutosize);

  var _super = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_3__["default"])(MatTextareaAutosize);

  function MatTextareaAutosize() {
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MatTextareaAutosize);

    return _super.apply(this, arguments);
  }

  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MatTextareaAutosize, [{
...
/** @docs-private */
ngControl) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MatInputBase);
...
var MatInput = /*#__PURE__*/function (_MatInputMixinBase2) {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(MatInput, _MatInputMixinBase2);

  var _super2 = Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_3__["default"])(MatInput);
  ...
  _formField) {
    ...
    Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MatInput);
  ...
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(MatInput, [{
    key: "disabled",
    get: function get() {
...
var MatInputModule = function MatInputModule() {
  Object(_Users_Paulo_NetBeansProjects_CyberOficinaAngular_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, MatInputModule);
};
...
/* harmony import */ var app_orcamento_orcamento_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/orcamento/orcamento.component */ "TXLl");
/* harmony import */ var app_meus_orcamentos_meus_orcamentos_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/meus-orcamentos/meus-orcamentos.component */ "tgHG");
...
var AdminLayoutRoutes = [
    ...
    { path: 'orcamento', component: app_orcamento_orcamento_component__WEBPACK_IMPORTED_MODULE_8__["OrcamentoComponent"] },
    { path: 'meus-orcamentos', component: app_meus_orcamentos_meus_orcamentos_component__WEBPACK_IMPORTED_MODULE_9__["MeusOrcamentosComponent"] },
];
