$(function () {
    ...
    $("#edit-profile input,#edit-profile edit").jqBootstrapValidation({
        ...
        submitSuccess: function ($form, event) {
            ...
            $.ajax({
                url: "https://www.cyberoficina.com.br/editProfile",
                //url: "http://localhost:8080/CyberOficina/editProfile",
                type: "POST",
                data: {
                    idUser: idUser,
                    telefone: telefone,
                ...
                success: function () {
                    ...
                    $('#successEdit').html("<div style='position: absolute; width: 90%' class='mt-2 alert alert-success'>");
